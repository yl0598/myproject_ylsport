...
品牌名称: <input type="text" name="name" value="${searchName }"/>
	...
	<tbody class="pn-ltbody">
	  <c:forEach items="${pagination.list }" var="entry">
		...
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" href="#">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;} window.location.href='/brand/delete.do?id=${entry.id}&name=${searchName}&isDisplay=${isDisplay}'" href="javascript:void(0)">删除</a>
			</td>
		</tr>
	 </c:forEach>
